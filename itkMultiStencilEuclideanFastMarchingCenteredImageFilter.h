...
=========================================================================*/
#ifndef _itkMultiStencilEuclideanFastMarchingCenteredImageFilter_h
#define _itkMultiStencilEuclideanFastMarchingCenteredImageFilter_h
...
namespace itk
{
/** \class MultiStencilEuclideanFastMarchingCenteredImageFilter
...
class ITK_EXPORT MultiStencilEuclideanFastMarchingCenteredImageFilter
...
public:
  ...
  typedef MultiStencilEuclideanFastMarchingCenteredImageFilter 		Self;
  ...
  itkTypeMacro(MultiStencilEuclideanFastMarchingCenteredImageFilter, MultiStencilEuclideanFastMarchingImageFilterBase );
...
protected:
  ...
  virtual ~MultiStencilEuclideanFastMarchingCenteredImageFilter() {}
  ...
  virtual void ComputeEquivalentValues3D( unsigned int stencil,
				const InputIndexType& idx,
  ...
  virtual void ComputeEquivalentValues2D( unsigned int stencil,
				const InputIndexType& idx,
				const UpwindVectorType &upwind,
				const SignVectorType& sign,
				UpwindVectorType &eqUpwind,
...
private:
  MultiStencilEuclideanFastMarchingCenteredImageFilter(const Self&);	// purposely not implemented
...
#include "itkMultiStencilEuclideanFastMarchingCenteredImageFilter.txx"
#endif
