...
=========================================================================*/
#ifndef _itkMultiStencilEuclideanFastMarching2ndOrderImageFilter_h
#define _itkMultiStencilEuclideanFastMarching2ndOrderImageFilter_h
...
namespace itk
{
/** \class MultiStencilEuclideanFastMarching2ndOrderImageFilter
...
class ITK_EXPORT MultiStencilEuclideanFastMarching2ndOrderImageFilter
...
public:
  ...
  typedef MultiStencilEuclideanFastMarching2ndOrderImageFilter 		Self;
  ...
  itkTypeMacro(MultiStencilEuclideanFastMarching2ndOrderImageFilter, MultiStencilEuclideanFastMarchingImageFilterBase );
...
protected:
  ...
  virtual ~MultiStencilEuclideanFastMarching2ndOrderImageFilter() {}
  ...
  virtual void ComputeEquivalentValues( unsigned int stencil,
				const InputIndexType& idx,
...
private:
  MultiStencilEuclideanFastMarching2ndOrderImageFilter(const Self&);	// purposely not implemented
...
#include "itkMultiStencilEuclideanFastMarching2ndOrderImageFilter.txx"
#endif
